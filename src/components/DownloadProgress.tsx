...
export default function GameDownloadProgress() {
	...
	return (
		<div class="flex flex-col w-full h-auto gap-y-3 justify-start items-start align-bottom text-white hover:bg-black/75 transition-colors duration-200 px-4 py-5">
