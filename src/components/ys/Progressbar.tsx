...
export default function YsProgressbar({ progress }: { progress: number }) {
	return (
		<div class="flex flex-row gap-0 items-center h-10 w-full max-w-md">
			<Diamond />
			<div
				class="bg-[#242424] h-5 flex-1"
				style={{
					clipPath:
			...
			>
				<div
					...
					class="bg-[#f1f2f3] h-full transition-all duration-300"
				></div>
			</div>
			<Diamond />
		</div>
